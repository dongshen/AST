...
public class CoverityAstParseTest {
	...
	public void testParse_ForDefinition() {
		...
		try {
			...
			List<CoverityAstFunction> deflist = parse.parse(contentList);

			// check total
			assertEquals(6, deflist.size());

			// check first one
			CoverityAstFunction def = deflist.get(0);
			assertEquals("D:/git/benchmark/src/main/java/org/owasp/benchmark/testcode/BenchmarkTest00001.java",
					def.getFileName());
			assertEquals(CoverityAstFunction.DefinitionType.CLASS, def.getType());
			...
			assertEquals("D:/git/benchmark/src/main/java/org/owasp/benchmark/testcode/BenchmarkTest00001.java",
					def.getFileName());
			assertEquals(CoverityAstFunction.DefinitionType.FUNCTION, def.getType());
			assertEquals(
			...
			assertEquals("D:/git/benchmark/src/main/java/org/owasp/benchmark/testcode/BenchmarkTest00001.java",
					def.getFileName());
			assertEquals(CoverityAstFunction.DefinitionType.GLOBAL, def.getType());
