...
public class BuildJavaTest {

	static Logger logger = Logger.getLogger(BuildJavaTest.class);
	...
	public void testBuildJavaSimple() {
		...
		// 在这个TypeDeclaration实例中添加类Program中的方法main()
	...
	public void testBuildJava() {
		...
		/*
		 * 定义一个方法,形如: public String getString(String name){ String newString =
		 * name + "你好"; return newString; }
		 */
		...
		/**
		 * 定义一个方法,形如: public String isOdd(int a) throws NullPointerException,
		 * Exception{ if(a < 0) throw new Exception("数字不能为负数");
		 * 
		 * if(a % 2 == 0){ return "偶数"; }else{ System.out.println("完"); return
		 * "奇数"; }
		 */
		{
